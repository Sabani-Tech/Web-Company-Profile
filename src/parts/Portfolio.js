    ...
    <section className="container mx-auto flex flex-col items-center mt-20">
      <Fade bottom>
        ...
        <p className="font-light text-lg text-gray-400 text-center mb-12">
          Kami siap untuk meningkatkan bisnis Anda dengan hasil kerja yang luar
          biasa.
        </p>
      </Fade>
      ...
      <Fade bottom>
        <Button
          href="/project"
          type="link"
          className="flex flex-grow-0 w-36 h-12 sm:w-40 sm:h-14 lg:w-44 lg:h-16 xl:w-36 xl:h-12 text-green-950 px-5 border border-green items-center mt-14 rounded-full justify-center transition duration-300 hover:bg-green-500 hover:text-white"
        >
