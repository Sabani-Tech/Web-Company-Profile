  ...
  return (
    <div className="bg-gray-50">
      <div className="container mx-auto pt-20 pb-28">
        <Fade bottom>
          <h1 className="text-5xl text-theme-deep-green text-center font-bold">Layanan Kami</h1>
                          ...
                          <Fade bottom delay={500 * index}>
                            <div>
                              <div className="bg-white group rounded-2xl shadow-2xl border border-light-theme-green transform transition duration-500 hover:scale-105">
                                ...
                                <h2 className="text-theme-deep-green text-center text-xl py-7 rounded-b-2xl">{item.title}</h2>
                              </div>
                            </div>
                          </Fade>
                        ))
